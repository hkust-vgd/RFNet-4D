...
class Generator3D(object):
    ...
    def generate_from_latent(self,
        ...
        Args:
            ...
            c_s (tensor): latent conditioned code c_s
        ...
        if self.upsampling_steps == 0:
            ...
            pointsf = box_size * make_3d_grid((-0.5, ) * 3, (0.5, ) * 3,
                                              (nx, ) * 3)
            values = self.eval_points(pointsf, z, c_s, **kwargs).cpu().numpy()
            ...
            while points.shape[0] != 0:
                ...
                values = self.eval_points(pointsf, z, c_s, c_t,
                                          **kwargs).cpu().numpy()
        ...
        mesh = self.extract_mesh(value_grid, z, c_s, stats_dict=stats_dict)

        return mesh

    def eval_points(self, p, z, c_s=None, c_t=None, **kwargs):
        ...
        for pi in p_split:
            ...
            with torch.no_grad():
                ...
                p_t_at_t0, flow_features = self.model.transform_to_t0(time_val,
                                                                      pi,
                                                                      c_t=c_t)
                occ_hat = self.model.decode(p_t_at_t0, flow_features, z, c_s,
                                            **kwargs).logits
